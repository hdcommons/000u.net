export function CBTransferIcon() {
  return (
    <svg
      className="el-transfer-icon"
      style={{ width: 14, height: 14, transform: "rotate(45deg)", marginTop: -2 }}
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
    >
      <g className="el-transfer-plane-group">
        <path
          strokeLinecap="round"
...
export function CBChargeIcon() {
  return (
    <svg className="el-charge-icon" style={{ width: 14, height: 14 }} fill="currentColor" viewBox="0 0 24 24">
...
export function TBTransferIcon() {
  return (
    <svg
      className="el-transfer-time-icon"
    ...
    >
      ...
      <g className="el-transfer-time-hand">
